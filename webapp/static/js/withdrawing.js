    ...
    function wewbInit() {
        ...
        akAjax('post','/akadmin/caseAccon/dwdetails',{bsnJrnlNo:bsnJrnlNo},function(data){
        	if (data && data.status ===1) {
                ...
                $payMoney.val(data.akInvlvAmtIfmtDo.accba);
                $payMoneyCapital.val(smalltoBIG(data.akInvlvAmtIfmtDo.accba));
    ...
    $infForm.submit(function () {
        ...
        akAjax('post','/akadmin/ntc/drawdown',obj,function(data){
        	if (data && data.status == 1) {
                ...
                window.location.href = './withdrawNotePrint?bsnJrnlNo=' + data.bsnJrnlNo;
            } else {
